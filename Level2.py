...
def Level2Start(t, w, h, f):
    pygame.init()
    Level2Object = Level2(t, w, h, f)
    Level2Object.startLevel()
...
class Level2:
    ...
    def __init__(self, t, w, h, f):
        ...
        self.offsetX = 0
        self.offsetY = 0
        self.testImage = pygame.image.load('images/test2.png')
    ...
    def checkWin(self):
        if self.imageSlotPos == [0, 1, 2, 3]:
            pygame.quit()
            try:
                Level3.Level3Start(self.TITLE, self.WIDTH, self.HEIGHT, self.FRAMERATE)
            except:
                EndingMenu.createMenuFromLevel()

# Sets default values for testing if not launched from MainMenu.py
if __name__ == "__main__":
    Level2Start("DEFAULT", 1280, 720, 30)
